...
1. Open a terminal in this project folder (Smart Crack Detection). If you do not already have [Git](https://git-scm.com/), download it for later steps such as installing detectron2.
...
5. Install detectron2, the instance segmentation framework used by Smart Crack Detection
...
7. If everything ran smoothly, run Smart Crack Detection by
